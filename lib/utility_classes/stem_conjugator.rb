		...
		when "I" # SHADDA FATHA NEEDED ON PERFECT ENTUN FOR SOUND/ASSIMILATED/HAMZATED
			...
			when {root_category: "defective", root_subcategory: "defective-w"}, {root_category: "defective", root_subcategory: "defective-y-fa_ka"}
				...
				return [
					...
					ArabicConjugation.new( "entun", :subjunctive, ["t", stem.root[0], stem.root[1], stem.root[2], "n"], ["fa", "sk", stem.vocalization["imperfect_kicker"], nil, "fa"] ),
					ArabicConjugation.new( "hoon", :subjunctive, ["y", stem.root[0], stem.root[1], stem.root[2], "n"], ["fa", "sk", stem.vocalization["imperfect_kicker"], nil, "fa"] ),
					ArabicConjugation.new( "entuma", :subjunctive, ["t", stem.root[0], stem.root[1], stem.root[2], "aa"], ["fa", "sk", stem.vocalization["imperfect_kicker"], nil, nil] ),
					...
					ArabicConjugation.new( "entum", :imperative, ["aa", stem.root[0], stem.root[1], "w", "aa"], [stem.vocalization["imperfect_kicker"], "sk", merged_vowel, nil, nil] ),
